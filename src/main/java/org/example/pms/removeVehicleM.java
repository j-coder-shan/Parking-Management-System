...
public class removeVehicleM implements WindowManager{
    ...
    public void printBill(String arrival_Time, String departure_Time, int hours, int minutes, int seconds, int paymentAmount, String licensePlateNumber) {
        ...
        stage.show();
        removeVehiclePA.savePaymentAndDateToFile(licensePlateNumber,payment,arrival_Time ,departure_Time);
    }
    @FXML
    public void remove_Vehicle() {
        ...
        String removedFile = "src\\main\\resources\\org\\example\\pms\\removed_Vehicles.txt";
