...
public class addVehiclePA extends ParkingAttendantWindow {
    ...
    public void removeVehicle_AV(ActionEvent event) throws IOException {
        removeVehicle(event);
    }
    public void logout_AV(ActionEvent event) throws IOException {
        logout(event);
    }
